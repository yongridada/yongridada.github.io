...
site_url = "https://yongridada.github.io"  # 需修改为自己的网址
username = "yongridada" # GitHub 用户名，需修改为自己的用户名
token = " 9462ba864f52d46f641847fe7c87e881a5d0dab2"   # GitHub Token，在账户设置中申请
repo_name = "yongridada.github.io"  # 存放 issues，需修改为自己的仓库名
